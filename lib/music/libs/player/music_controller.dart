...
class MyAudioHandler extends BaseAudioHandler {
  ...
  PlaybackState _transformEvent(PlaybackEvent event) {
    return PlaybackState(
      controls: [
        ...
        playerController.player.playing ? MediaControl.pause : MediaControl.play,
        MediaControl.stop,
  ...
  @override
  Future<void> play() => playerController.player.play();

  @override
  Future<void> pause() => playerController.player.pause();
