...
class ParesVideoPlayerPage extends StatefulWidget {
  final ParesVideo paresVideo;

  const ParesVideoPlayerPage({required this.paresVideo});

  @override
  State<ParesVideoPlayerPage> createState() => _LocalVideoPlayerPagesState();
}

class _LocalVideoPlayerPagesState extends State<ParesVideoPlayerPage> {
  ...
  void initializePlayer() async {
    ...
    final savedPosition =
    await SPManager.getProgress(widget.paresVideo.vodPlayUrl);
    videoId = widget.paresVideo.vodPlayUrl;
    // 获取跳过时间
        ...
        body: Stack(
          children: [
            ...
            if (_isControllerVisible)
              MenuContainer(
                videoId: widget.paresVideo.vodPlayUrl,
                videoTitle: widget.paresVideo.vodName ?? "",
